; -------------------------------------------------------------------------------------------------------------------
; El siguiente código realiza la operación de división para número de 16 bits (2 bytes)
...
; 	Divisor:	 	  R3		 R2
; 	Resultado: 	  R5		 R4
; Tanto el algoritmo como el código fueron encontrados en www.8052.com/div16
; -------------------------------------------------------------------------------------------------------------------
